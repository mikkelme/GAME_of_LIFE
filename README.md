...
| Click on the **SYM** button.| Generates a random configuration of uniform distribution for half the grid corresponding to the set probability and mirrors it to the other half through the vertical centerline.|
| Slider | |
| 10 x 10 | |
| Refresh dim| |
| Reset | |
